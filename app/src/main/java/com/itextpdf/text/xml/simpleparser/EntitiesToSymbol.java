...
public class EntitiesToSymbol {
    ...
    static {
        ...
        MAP.put("8704", Character.valueOf(TokenParser.DQUOTE));
        ...
        MAP.put("8722", Character.valueOf(SignatureVisitor.SUPER));
        MAP.put("8727", '*');
        ...
        MAP.put("8756", Character.valueOf(TokenParser.ESCAPE));
        MAP.put("8764", '~');
        MAP.put("8773", '@');
        ...
        MAP.put("exist", '$');
        MAP.put("forall", Character.valueOf(TokenParser.DQUOTE));
        ...
        MAP.put("minus", Character.valueOf(SignatureVisitor.SUPER));
        MAP.put("mu", 'm');
        ...
        MAP.put("tau", 't');
        MAP.put("there4", Character.valueOf(TokenParser.ESCAPE));
        MAP.put("theta", 'q');
        MAP.put("thetasym", 'J');
