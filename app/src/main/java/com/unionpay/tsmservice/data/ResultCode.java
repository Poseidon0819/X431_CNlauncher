...
public class ResultCode {
    ...
    public static String getResultCode(String str) {
        return !TextUtils.isEmpty(str) ? "0000".equals(str) ? "" : "10001".equals(str) ? "00001" : ERROR_INTERFACE_APP_UNLOCK.equals(str) ? "00004" : ERROR_INTERFACE_GET_SMS_AUTH_CODE.equals(str) ? "00005" : ERROR_INTERFACE_GET_ACCOUNT_INFO.equals(str) ? "00006" : ERROR_INTERFACE_GET_ACCOUNT_BALANCE.equals(str) ? "00007" : ERROR_INTERFACE_HIDE_APP_APPLY.equals(str) ? "00008" : ERROR_INTERFACE_GET_CARD_INFO.equals(str) ? "00009" : ERROR_INTERFACE_GET_TRANS_RECORD.equals(str) ? "00010" : ERROR_INTERFACE_ECASH_TOPUP.equals(str) ? "00011" : ERROR_INTERFACE_SEND_APDU.equals(str) ? "00012" : ("10004".equals(str) || ERROR_INTERFACE_GET_APP_DETAIL.equals(str) || ERROR_INTERFACE_APP_LOCK.equals(str)) ? "00001" : ERROR_INTERFACE_OPEN_CHANNEL.equals(str) ? "00033" : ERROR_INTERFACE_CLOSE_CHANNEL.equals(str) ? "00023" : ERROR_INTERFACE_EXECUTE_CMD.equals(str) ? "00024" : ERROR_INTERFACE_GET_CARDINFO_BY_SAMSUNGPAY.equals(str) ? "00035" : ERROR_INTERFACE_CHECK_SSAMSUNGPAY.equals(str) ? "00025" : ERROR_INTERFACE_SET_SAMSUNG_DEFAULT_WALLET.equals(str) ? "00034" : "10034".equals(str) ? "00029" : "10035".equals(str) ? "00030" : "10036".equals(str) ? "00032" : "10037".equals(str) ? "00026" : ERROR_INTERFACE_ADD_CARD_TO_VENDOR_PAY.equals(str) ? "00027" : "10039".equals(str) ? "00028" : ERROR_INTERFACE_PREDOWNLOAD.equals(str) ? "00036" : "1".concat(String.valueOf(str)) : "00000";
    }
}
