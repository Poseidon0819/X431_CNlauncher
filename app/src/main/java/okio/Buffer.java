...
public final class Buffer implements Cloneable, ByteChannel, BufferedSink, BufferedSource {
    private static final byte[] DIGITS = {ByteBuffer.ZERO, 49, 50, 51, SmileConstants.TOKEN_KEY_LONG_STRING, 53, 54, 55, 56, 57, 97, 98, 99, 100, 101, 102};
    ...
    public final InputStream inputStream() {
        return new InputStream() { // from class: okio.Buffer.2
            ...
            public int available() {
                return (int) Math.min(Buffer.this.size, (long) TTL.MAX_VALUE);
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:52:0x00b7 A[EDGE_INSN: B:52:0x00b7->B:42:0x00b7 ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00a1 A[EDGE_INSN: B:43:0x00a1->B:37:0x00a1 ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final long readHexadecimalUnsignedLong() {
        ...
        L4c:
            ...
            r2.<init>()
            okio.Buffer r0 = r2.writeHexadecimalUnsignedLong(r0)
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int selectPrefix(okio.Options r18, boolean r19) {
        /*
            r17 = this;
            r0 = r18
            r1 = r17
    ...
    public final int read(java.nio.ByteBuffer byteBuffer) throws IOException {
        Segment segment = this.head;
        if (segment == null) {
            return -1;
        }
    ...
    public final int write(java.nio.ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer == null) {
            throw new IllegalArgumentException("source == null");
        }
    ...
    public final ByteString sha512() {
        return digest(DigestAlgorithms.SHA512);
    }
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m184of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m184of(mac.doFinal());
