...
public class LayoutRelative extends RelativeLayout {
    ...
    private DisplayMetrics getDisplayMetrics() {
        if (this.f8504a == null) {
            this.f8504a = new DisplayMetrics();
            ((WindowManager) getContext().getSystemService("window")).getDefaultDisplay().getMetrics(this.f8504a);
        }
        return this.f8504a;
    }
                ...
                if (str != null) {
                    ...
                    if (jSONObject.has("base")) {
                        if (jSONObject.getString("base").equals("width")) {
                            m9107a(childAt, jSONObject, displayWidth);
                        } else if (jSONObject.getString("base").equals("height")) {
                            m9107a(childAt, jSONObject, displayHeight);
                        }
                    }
                }
    ...
    /* renamed from: a */
    private static void m9107a(View view, JSONObject jSONObject, int i) throws JSONException, NullPointerException {
