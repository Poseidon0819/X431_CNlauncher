...
public class MapFragment extends Fragment {
    ...
    /* renamed from: a */
    private static final String f5072a = "MapFragment";

    /* renamed from: b */
    private MapView f5073b;

    /* renamed from: c */
    private BaiduMapOptions f5074c;

    public MapFragment() {
    }

    private MapFragment(BaiduMapOptions baiduMapOptions) {
        this.f5074c = baiduMapOptions;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f5073b = new MapView(getActivity(), this.f5074c);
        return this.f5073b;
    }
